...
namespace GXPEngine
{
	...
	public class Canvas : Sprite
	{
		...
		public void DrawSprite(Sprite sprite) {
			...
			Core.Vector2 p0 = sprite.TransformPoint(-halfWidth, -halfHeight);
			Core.Vector2 p1 = sprite.TransformPoint(halfWidth, -halfHeight);
			Core.Vector2 p2 = sprite.TransformPoint(-halfWidth, halfHeight);
