...
public class SoundChannel
{
	...
	public bool Mute
	{
		...
		{
			_isMuted = value;
			_system.SetChannelVolume(_id, value ? 0f : _volume);
		}
	}
	...
	/// <summary>
	/// Gets or sets a value indicating whether this <see cref="SoundChannel"/> is paused.
	/// </summary>
	/// <value>
	...
	/// <summary>
	/// Gets a value indicating whether this <see cref="SoundChannel"/> is playing. (readonly)
	/// </summary>
	/// <value>
