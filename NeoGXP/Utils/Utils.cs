...
public static class Utils
{
	...
	private static Dictionary<string, SKTypeface> fontIndex=null;
	...
	public static SKFont LoadFont(string filename, float fontSize, SKFontStyle fontStyle = null) {
		...
		return new SKFont(SKTypeface.FromFamilyName(fontIndex[filename].FamilyName, fontStyle ?? SKFontStyle.Normal), fontSize);
	}
