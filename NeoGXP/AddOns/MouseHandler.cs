...
public class MouseHandler
{
	...
	/// <summary>
	/// Updates the internal administrates and triggers events where required.
	/// </summary>
	private void HandleOnStep ()
	{
		...
		switch (_wasMouseDown)
		{
			...
			case false when Input.GetMouseButton (0):
			{
				...
				_offset.x -= (float)Input.mouseX;
				_offset.y -= (float)Input.mouseY;
				break;
			}
	...
	public Vec2 offsetToTarget => _offset;
