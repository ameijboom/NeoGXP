...
public class Window {
	...
	private void SetRenderRange() {
		...
		worldSpaceCorners[0] = camera.TransformPoint(-_width/2f, -_height/2f);
		worldSpaceCorners[1] = camera.TransformPoint(-_width/2f,  _height/2f);
		worldSpaceCorners[2] = camera.TransformPoint( _width/2f,  _height/2f);
		worldSpaceCorners[3] = camera.TransformPoint( _width/2f, -_height/2f);
